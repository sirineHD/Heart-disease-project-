...
## Machine Learning Classification Project with different models 
# Description of the data
Problem Definition In our case, we will be exploring a binary classification (a sample can only be one of two things).
